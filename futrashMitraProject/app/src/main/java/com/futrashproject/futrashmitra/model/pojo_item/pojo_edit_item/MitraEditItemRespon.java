...
package com.futrashproject.futrashmitra.model.pojo_item.pojo_edit_item;
...
public class MitraEditItemRespon {
     ...
     * @param updatedAt
     */
    public MitraEditItemRespon(String createdAt, String updatedAt, long id, String jenisMakanan, String tidakDikonsumsiSejak, String dijualKarena, String beratMakanan, String namaToko, String namaPenjual, String lokasiMakanan, String hargaMakanan, String saranPenggunaan, String kandunganKimia, String phoneNumber, User user) {
        super();
